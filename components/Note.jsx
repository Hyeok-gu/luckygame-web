  ...
  return (
    <div className={styles.noteModal}>
      <div className={styles.noteInner}>
        ...
        <p className={styles.title}>서비스 제작자 노트</p>
        <p className={styles.desc}>
          ...
          가볍게 활용해주시면 큰 힘이 될 것 같습니다. 서비스 제작자도
          사람인지라… 상처받을까 조금 무서워서 드리는 부탁입니다. 😅 부족한
          부분이 있다면 천천히 개선해 나가겠습니다. 사용해 주셔서 감사합니다!
        </p>
        <ul className={styles.list}>
          ...
          <li className={styles.item}>
            ...
            <span className={styles.ex}>
              💡사신 다이안은 궁극기 중첩을 적용했습니다. 만약 죽음의 손길 발동
              시간(20초)보다 마나 회복 속도가 빠른 경우, 궁극기 중첩되며 피해량
              또한 중첩되어 합산됩니다.
            </span>
            <span className={styles.ex}>
